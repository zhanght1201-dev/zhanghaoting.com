...
(async()=>{
 ...
 await page.locator('[data-filter=reading]').click();assert.equal(await page.locator('[data-note]:visible').count(),await page.locator('[data-note][data-category=reading]').count());await page.locator('[data-filter=all]').click();assert.equal(await page.locator('[data-note]:visible').count(),totalNotes);
